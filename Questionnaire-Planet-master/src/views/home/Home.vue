...
<!--   <el-footer class="footbottom">&ndash;&gt;-->
<!--      <p>Copyright © 2021 {{ domain }}. All rights reserved.</p>-->
<!--          <p>官方邮箱：<a :href=sendtoEmail>{{ email }}</a></p>&ndash;&gt;-->
<!--          <p><a href="https://beian.miit.gov.cn/" target="_blank">粤ICP备2021021248号</a></p>&ndash;&gt;-->
<!--   </el-footer>&ndash;&gt;-->
  </div>
</template>
  ...
  data(){
    return{
      ...
      topImg:[
        {
          'title':'问卷发布平台',
          'subTitle':'Questionnaire Publishing Platform',
